...
const Aptis = () => {
  ...
  const translations = {
    en: {
      title: "What is APTIS?",
      text1: "What Is APTIST ? A Complete Introduction",
      text2:
    ...
    ru: {
      title: "Что такое АПТИС?",
      text1: "Что такое АПТИСТ? Полное введение",
      text2:
    ...
    <div id="aptis">
      <div className="container">
        <div className="aptis">
          ...
          <div className="aptis--block"></div>
          <img src={api} width={1400} alt="img" />
