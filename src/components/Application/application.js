                ...
                <div className="application">
                    <div className="application--right">
                        ...
                        <div className="application--right__email">
                            <input className="inputs" type="text" placeholder={"Phone"}/>
                            <div className="application--right__line"></div>
                        ...
                        <div className="application--right__group">
                            ...
                            <textarea className="application--right__group--help" type="text"
                                      placeholder={"How can we help?"}/>
                            <div className="block">
                                <button className="application--right__group--btn">Submit</button>
                            </div>
                        </div>
                    </div>
                    <div className="application--left">
                        <div className="application--left__info">
                            <div onClick={() => setSend(true)} className="application--left__info--line"><svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 56 56" fill="none">
                                <rect width="56" height="56" rx="28" fill="#E5EA00"/>
                                <path d="M28.5771 31.0701C28.745 32.3354 28.3429 33.662 27.3706 34.6343L23.5819 38.423C21.9237 40.0811 19.2353 40.0811 17.5771 38.423C15.919 36.7648 15.919 34.0764 17.5771 32.4182L21.3658 28.6295C22.3381 27.6572 23.6647 27.255 24.93 27.423M27.4232 24.9297C27.2553 23.6644 27.6575 22.3379 28.6298 21.3656L32.4185 17.5769C34.0766 15.9187 36.765 15.9187 38.4232 17.5769C40.0814 19.235 40.0814 21.9235 38.4232 23.5816L34.6345 27.3703C33.6622 28.3426 32.3357 28.7448 31.0703 28.5768M24.93 31.0701L31.0703 24.9297" stroke="#212121" stroke-width="1.3" stroke-linecap="square"/>
                            </svg></div>
                        ...
                        <div className="send">
                            <div className="send--titles">
                                ...
                                <div className="send--titles__apple">
                                    <div className="send--titles__apple--whatsapp"><svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
