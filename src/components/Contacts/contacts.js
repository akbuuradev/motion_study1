              ...
              <div className="detail">
                <div className="detail--open">
                  ...
                  <div className="detail--open__name">
                    <h2>{translations[language].text2}</h2>
                    <h3>
                      {firstName} {lastName}
                    </h3>
                  </div>
                  ...
                  <div className="detail--open__email">
                    <h2>{translations[language].text4}</h2>
                    <h3>{email}</h3>
                  </div>
                  <div className="detail--open__group">
                    <h2>{translations[language].text5}</h2>
                    <h3>{group}</h3>
                  </div>
                  <div className="detail--open__help">
                    <h2>{translations[language].text6}</h2>
                    <h3>{help}</h3>
                  </div>
                </div>
              </div>
            ...
            {send && (
              <div className="send">
                <div className="send--titles">
                  <h1>{translations[language].text9}</h1>
                  ...
                  <button
                    ...
                    className="send--titles__btn"
                  >
                    {translations[language].text11}
                  </button>
                </div>
              </div>
            )}
