                ...
                <div className="application">
                    <div className="application--right">
                        ...
                        <div className="application--right__name">
                            <input onChange={(e) => setFirstName(e.target.value)} className="inputs lol" type="name"
                                   placeholder={"First Name"}/>
                            <div className="application--right__line"></div>
                            <input onChange={(e) => setLastName(e.target.value)} className="inputs lol1" type="name"
                                   placeholder={"Last Name"}/>
                            <div className="application--right__line"></div>
                        </div>
                        <div className="application--right__email">
                            <input onChange={(e) => setPhone(e.target.value)} className="inputs lol2" type="phone"
                                   placeholder={"Phone"}/>
                            <div className="application--right__line"></div>
                            <input onChange={(e) => setEmail(e.target.value)} className="inputs lol3" type="email"
                                   placeholder={"Email"}/>
                            <div className="application--right__line"></div>
                        </div>
                        <div className="application--right__group">
                            <input onChange={(e) => setGroup(e.target.value)}
                                   className="application--right__group--com lol4" type="text"
                                   placeholder={"Group or Company"}/>
                            <textarea onChange={(e) => setHelp(e.target.value)}
                                      className="application--right__group--help  lol5" type="text"
                            ...
                            <div className="block">
                                <button onClick={() => {
                                    ...
                                    lol5.value = '';
                                        ...
                                        className="application--right__group--btn">Submit
                                </button>
                        ...
                        {detail && (
                            <div className="detail">
                                <div className="detail--open">
                                    <h1 className="detail--open__none" onClick={() => setDetail(false)}>x</h1>
                    ...
                    <div className="application--left">
                        <div className="application--left__info">
                            <div onClick={() => setSend(true)} className="application--left__info--line">
                            ...
                            <div className="application--left__info--main">
                                <div className="application--left__info--main__block">
                                    ...
                                    <div className="application--left__info--main__block--plane">
                                        <BiLogoTelegram/>
                                        <IoLogoWhatsapp
                                            className="application--left__info--main__block--plane__whatsapp"/>
                                        <BiLogoInstagramAlt/>
                                    </div>
                        ...
                        {send && (
                            <div className="send">
                                <div className="send--titles">
                                    ...
                                    <div className="send--titles__apple">
                                        <div className="send--titles__apple--whatsapp">
                                        ...
                                        <div className="send--titles__apple--instagram">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                                                 viewBox="0 0 48 48" fill="none">
                                                <rect width="48" height="48" rx="24"
                                                      fill="url(#paint0_radial_1036_1947)"/>
                                                <rect width="48" height="48" rx="24"
                                                      fill="url(#paint1_radial_1036_1947)"/>
                                                <path
                                        ...
                                        <div className="send--titles__apple--facebook">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                                                 viewBox="0 0 48 48" fill="none">
                                        ...
                                        <div className="send--titles__apple--telegram">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                                                 viewBox="0 0 48 48" fill="none">
                                    ...
                                    <button onClick={() => setSend(false)} className="send--titles__btn">Done</button>
                                </div>
                            </div>
                        )}
                    </div>
