...
import italianUniversitiesData from "../../Data/Italy";
        ...
        <div id="rome">
            <div className="container">
                ...
                <div className="rome">
                    ...
                    {
                       italianUniversitiesData.slice(line ? 0 : 5, line ? 5 : 10).map((el) => (
                           <div className="rome--aldo">
                               <div className="rome--aldo__moro">
                                   <img src={el.image} alt=""/>
                                   <div className="rome--aldo__moro--name">
                                       <h3>Name:</h3>
                                       <h2>{el.name}</h2>
                                   </div>
                                   <div className="rome--aldo__moro--location">
                                       <p>Location <IoLocationOutline style={{color: "#9D72D6"}}/></p>
                                       <h2>{el.location}</h2>
                                   </div>
                                   <div className="rome--aldo__moro--age">
                                       <p>Age:</p>
                                       <h2>From {el.age}</h2>
                                   </div>
                               </div>
