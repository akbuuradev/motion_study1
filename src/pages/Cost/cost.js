            ...
            <div className="container">
                <div className="cost">
                    <div className="cost--title">
                        <div className="cost--title__photo">
                            <NavLink className="cost--title__photo--item" to={"/"}>Description</NavLink>
                            <NavLink className="cost--title__photo--item" to={"/"}>Cost</NavLink>
                            <NavLink className="cost--title__photo--item" to={"/"}>Photo</NavLink>
                        </div>
                    </div>
                    <div className="cost--time">
                            <div className="cost--time__right">
                                <div className="cost--time__right--now">
                                    <img src={cost} alt=""/>
                                    <div className="cost--time__right--now__share">
                                        <h1>Landscape Design</h1>
                                        <h2>University of Fashion and Design</h2>
                                    </div>
                                </div>
                                <h3><span>Nominal duration:</span> 4.5 years(240 ECTS)</h3>
                                <div className="cost--time__right--awards">
                                    <h2>Awards:</h2>
                                ...
                                <div className="cost--time__right--line"></div>
                                <div className="cost--time__right--tuition">
                                    <h2>Tuition fee:</h2>
                                    <p>€1,400 per semester
                                        US$1,502.87</p>
                                </div>
                                <div className="cost--time__right--one">
                                    <h2>Application fee:</h2>
                                    <p>€120 one-time
                                        US$128.83</p>
                                </div>
                                <div className="cost--time__right--base">
                                ...
                                <div className="cost--time__right--line"></div>
                                <div className="cost--time__right--high">
                                    <h2>Tuition fee:</h2>
                                    <p><span>High school / secondary education (or higher)</span>
                                        Completed Secondary Education ( 12 years, in some countries 11 years)</p>
                                </div>
                                <div className="cost--time__right--entry">
                        ...
                        <div className="cost--time__left">
                            <div className="cost--time__left--for">
                                <h2><span>Apply Now!!!</span> Fall semester 2023</h2>
                                <div className="cost--time__left--for__you">
                                ...
                                <div className="cost--time__left--for__apple">
                                    <LuCalendarCheck2 className="icons"/>
                                    <p><span>Application deadline</span>
                                        31 Aug 2023, 23:59:59Eastern European Time
                                        Autumn Intake</p>
                                </div>
                                <div className="cost--time__left--for__commence">
                                    <BsBank  className="icons"/>
                                    <p><span>Studies commence</span>
                                        4 Sept 2023</p>
                                </div>
                                    <h3><span>Apply Now!!!</span>  Spring semester 2023</h3>
                                <div className="cost--time__left--for__has">
                                    <BiSolidErrorCircle className="icons"/>
                                    <p>Application period has ended</p>
                                </div>
                                <div className="cost--time__left--for__studies">
                                    <BsBank className="icons"/>
                                    <p><span>Studies commence <br/></span>
                                        6 Feb 2023</p>
                                </div>
                                <div className="cost--time__left--for__line"></div>
                                <div className="cost--time__left--for__share">
                                    <h4>Share on:</h4>
                                    <div className="cost--time__left--for__share--images">
